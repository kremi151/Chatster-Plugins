...
class MessagingCommandAdapter(
        private val commandContext: CommandContext
): MessagingAdapter {

    override val sender: SenderReference get() = commandContext.sender

    override val message: String? = null

    override fun sendTextMessage(message: String) {
        commandContext.sendTextMessage(message)
    }

    override fun sendFile(file: File) {
        commandContext.sendTextMessage(file)
    }
